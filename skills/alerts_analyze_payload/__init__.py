...
MANIFEST = {
    ...
    "description": (
        ...
        "(2) 收到第三方告警系统推送，想自动决定先调 zabbix_get_host_overview / "
        "kube_query(verb=describe, resource=pod) / swarm_query(category=service, verb=inspect) "
        "中哪个——本 skill 返回 plan 字段直接给 next_skill 建议；\n"
